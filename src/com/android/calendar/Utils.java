...
import android.accounts.AccountManager;//added by Fujuan.Lin for RR565704
...
import android.os.SystemProperties;//added by Fujuan.Lin for RR565704
...
import android.util.DisplayMetrics;//added for FR602091 Porting Wave3 Calendar to soul45 by yubin.yi.hz at 2014-02-13
import android.text.style.URLSpan;
import android.text.util.Linkify;
import android.util.Log;
import android.view.WindowManager;//added for FR602091 Porting Wave3 Calendar to soul45 by yubin.yi.hz at 2014-02-13
...
public class Utils {
    ...
    public static int getFirstDayOfWeek(Context context) {
        ...
        // Customize the default first day of week
        // For example, we will customize Monday as default first day of week in
        // CLID for china regions.

        String pref = prefs.getString(
                GeneralPreferences.KEY_WEEK_START_DAY, GeneralPreferences
                        .getDefaultFirstDayOfWeek(context));
     ...
     */
    public static final boolean IS_FACEBOOK_DEVICE = !SystemProperties.get("ro.config.fb.appid",
            "0").equals("0") ? true : false;

    public static final String CALENDARS_ACCOUNT_TYPE_FACEBOOK = "facebook calendar";

    public static final String FACEBOOK_ACCOUNT_TYPE = "com.facebook.auth.login";

    /**
     * check wheather exist facebook account
     * 
     * @param context
     * @return
     */
    ...
    public static Account getFacebookAccount(Context context) {
        ...
        AccountManager accountManager = AccountManager.get(context);
        if (accountManager != null) {
            Account[] accounts = accountManager.getAccountsByType(FACEBOOK_ACCOUNT_TYPE);
     ...
     * @return
     */
    public static MatrixCursor matrixCursorFromCursor(Cursor cursor, List<String> deleteList) {
