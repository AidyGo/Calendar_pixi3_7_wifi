...
public class AgendaWindowAdapter extends BaseAdapter
    ...
    // add facebook friend id 
    public static final int INDEX_FBFRIEND_ID = 17;

    private static final String[] PROJECTION =!Utils.IS_FACEBOOK_DEVICE ?  new String[] {
            Instances._ID, // 0
            Instances.TITLE, // 1
    ...
    public AgendaWindowAdapter(Context context,
        ...
        mHeaderView.setText(R.string.loading);
  		mHeaderView.setBackground(null);//added for FR602091 Porting Wave3 Calendar to soul45 by yubin.yi.hz at 2014-02-13
    ...
    private void updateHeaderFooter(final int start, final int end) {
        ...
        mHeaderView.setText("");
        mHeaderView.setBackgroundResource(R.drawable.query_up);

        //mFooterView.setText(mContext.getString(R.string.show_newer_events,
        //        formatDateString(end)));
        mFooterView.setText("");
        mFooterView.setBackgroundResource(R.drawable.query_down);
    }
