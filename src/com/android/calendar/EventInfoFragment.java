...
public class EventInfoFragment extends DialogFragment implements OnCheckedChangeListener,
    ...
    // modified by Fujuan.Lin for RR565704 begin
    // if it's facebook device add facebook features
    private static final String[] EVENT_PROJECTION = !Utils.IS_FACEBOOK_DEVICE ? new String[] {
    ...
    private static final int EVENT_INDEX_FBFRIEND_ID = 22;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        ///M: #extension# @{
           ...
           if (superMode)
           {
                Toast.makeText(getActivity(), R.string.cannot_use_in_ultimate_mode, Toast.LENGTH_SHORT)
                   .show();
                return false;
            }
    ...
    private void updateEvent(View view) {
        ...
        // added by Fujuan.Lin for RR565704 begin
        // if it's a facebook device ,obtain friend id and birthday color.
        if (Utils.IS_FACEBOOK_DEVICE) {
            String fbFriendId = mEventCursor.getString(EVENT_INDEX_FBFRIEND_ID);
            if (!TextUtils.isEmpty(fbFriendId)) {
                mCurrentColor = Utils.getFBBithdayColor();
            }
        }
        // added by Fujuan.Lin for RR565704 end
              ...
              //huanglin 20140104 for PR576713
                ...
                textView.setOnTouchListener(new OnTouchListener() {
                    ...
                    public boolean onTouch(View v, MotionEvent event) {
                        ...
                        if (superMode)
                        {
                            Toast.makeText(mContext, R.string.cannot_use_in_ultimate_mode, Toast.LENGTH_SHORT)
                            .show();
                            return false;
                        }
                        try {
    ...
    public void onPause() {
		...
		mContext.sendBroadcast(new Intent("com.event.ACTION_BACK"));
