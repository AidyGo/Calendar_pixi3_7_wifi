...
public class SimpleWeekView extends View {
    ...
    public void setWeekParams(HashMap<String, Integer> params, String tz) {
        ...
        if (mShowWeekNum) {
            ...
            // If we're showing the week number calculate it based on value of preferences_first_week_option
            mDayNumbers[0] = Integer.toString(Utils.getWeekNumberFromTime(time.toMillis(true), this.getContext()));
