...
public class SelectCalendarsSimpleAdapter extends BaseAdapter implements ListAdapter,
    ...
    private static Context mContext;//FR593012-Wentao-Wan-001
    ...
    public SelectCalendarsSimpleAdapter(Context context, int layout, Cursor c, FragmentManager fm) {
        super();
        mContext = context;//FR593012-Wentao-Wan-001
        mLayout = layout;
    ...
    private void initData(Cursor c) {
        ...
        long id = -1;//FR593012-Wentao-Wan-001
        ...
        while (c.moveToNext()) {
            ...
            if(id == 1 && mData[p].displayName.equalsIgnoreCase(EditEventView.PC_SYNC_ACCOUNT_DISPLAY_NAME)){
               mData[p].displayName = mContext.getString(R.string.default_calendar_name);
               mData[p].ownerAccount = mContext.getString(R.string.default_calendar_name);
               }
