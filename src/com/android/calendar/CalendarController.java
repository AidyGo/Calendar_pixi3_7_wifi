...
public class CalendarController {
    ...
    public final static int MESSAGE_ID_START = OnScrollListener.SCROLL_STATE_FLING + 1;
    public final static int MESSAGE_ID_GOTO_TIME = MESSAGE_ID_START;
    public final static int MESSAGE_ID_SET_TIME = MESSAGE_ID_START+1;
    public final static int MESSAGE_ID_GO_TIME_FOR_HEADER = MESSAGE_ID_START+2;//added for FR602091 Porting Wave3 Calendar to soul45 by yubin.yi.hz at 2014-02-13
    ...
    public void sendMessageHandler(int id,Object obj)
    {
        if(mHandler != null)
        {
