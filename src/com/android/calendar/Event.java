...
public class Event implements Cloneable {
    ...
    // change EVENT_PROJECTION to add facebook features.
    ...
    private static final int PROJECTION_FRIEND_ID_INDEX = 20;
    ...
    public final Object clone() throws CloneNotSupportedException {
        ...
        // added by Fujuan.Lin for RR565704 begin
        // if it's a facebook device ,set 
        // the facebook friend id .
        if (Utils.IS_FACEBOOK_DEVICE) {
            e.fbFriendId = fbFriendId;
        }
        // added by Fujuan.Lin for RR565704 end
        return e;
    }
    ...
    public final void copyTo(Event dest) {
        ...
        // added by Fujuan.Lin for RR565704 begin
        // if it is a facebook device ,set the facebook 
        // friend id.
        if (Utils.IS_FACEBOOK_DEVICE) {
            dest.fbFriendId = fbFriendId;
        }
        // added by Fujuan.Lin for RR565704 end
    }
    ...
    public static final Event newInstance() {
        ...
        // added by Fujuan.Lin for RR565704 begin
        // if it is a facebook device ,set default friend id to "".
        if (Utils.IS_FACEBOOK_DEVICE) {
            e.fbFriendId = "";
        }
        // added by Fujuan.Lin for RR565704 end
    ...
    private static Event generateEventFromCursor(Cursor cEvents) {
        ...
        // added by Fujuan.Lin for RR565704 begin
        // if it is a facebook device ,obtain friend id.
        // if friend id is not "" ,obtain bithday color.
        if (Utils.IS_FACEBOOK_DEVICE) {
            String friendId = cEvents.getString(PROJECTION_FRIEND_ID_INDEX);
            if (!TextUtils.isEmpty(friendId)) {
                e.fbFriendId = friendId;
                e.color = Utils.getFBBithdayColor();
            } else {
                e.fbFriendId = "";
            }
        }
