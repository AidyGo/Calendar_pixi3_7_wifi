...
import java.util.List;//added by Fujuan.Lin for RR565704
                    ...
                    try {
                        ...
                        if (mUri==null || mModel.mId == -1) {
                            ...
                            if (Utils.IS_FACEBOOK_DEVICE) {
                                ...
                                deleteList.add(Utils.CALENDARS_ACCOUNT_TYPE_FACEBOOK);
                                matrixCursor = Utils.matrixCursorFromCursor(cursor, deleteList);
                            } else {
