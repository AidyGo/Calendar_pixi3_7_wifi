...
public class EditEventHelper {
    ...
    private Context mContext; //added by yong'an.zhong.hz for PR480901
    // modified by Fujuan.Lin for RR565704 begin
    public static final String[] EVENT_PROJECTION =  !Utils.IS_FACEBOOK_DEVICE ? new String[] {
            Events._ID, // 0
            Events.TITLE, // 1
            ...
            Events.EVENT_COLOR_KEY, // 24
            ExtConsts.LunarEvent.IS_LUNAR, ///M:25
            Events.FBFRIEND_ID // 26
    };
    // modified by Fujuan.Lin for RR565704 end;
    ...
    protected static final int EVENT_INDEX_FRIEND_ID = 26;
    ...
    public boolean saveEvent(CalendarEventModel model, CalendarEventModel originalModel,
        ...
        // added by Fujuan.Lin for RR565704 begin
        // set facebook friend id to model.
        if (Utils.IS_FACEBOOK_DEVICE && originalModel != null
                && !TextUtils.isEmpty(originalModel.mFrinedId)) {
            model.mFrinedId = originalModel.mFrinedId;
        }
        // added by Fujuan.Lin for RR565704 end
    ...
    public static void setModelFromCursor(CalendarEventModel model, Cursor cursor) {
        ...
        if (Utils.IS_FACEBOOK_DEVICE) {
        	//get facebook friend id
            model.mFrinedId = cursor.getString(EVENT_INDEX_FRIEND_ID);
        }
        // added by Fujuan.Lin for RR565704 end
    ...
    ContentValues getContentValuesFromModel(CalendarEventModel model) {
        ...
        // added by Fujuan.Lin for RR565704 begin
        if (Utils.IS_FACEBOOK_DEVICE && !TextUtils.isEmpty(model.mFrinedId)) {
            values.put(Events.FBFRIEND_ID, model.mFrinedId);
        }
        // added by Fujuan.Lin for RR565704 end
