...
public class CalendarAppWidgetProvider extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
	 ...
	 final String action = intent.getAction();//FR593012-Wentao-Wan-001
        if (LOGD)
        ...
        if(Utils.getWidgetUpdateAction(context).equals(action)
          ...
          performUpdate(context, appWidgetManager,appWidgetManager.
                 getAppWidgetIds(getComponentName(context)),null);
        }else{
